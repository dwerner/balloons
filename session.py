...
class Session:
    ...
    # NOTE: Legacy fork_proposal and merge_proposal block types are kept in models.py
    # for backwards compatibility with existing sessions. However, new proposals are
    # rendered directly from tool_use turns by ForkProposalCard/MergeProposalCard.
    # The add_*_proposal_turn and update_*_proposal_status methods have been removed.
