...
class BackendConfig:
    ...
    Attributes:
        ...
        type: Backend type - "claude" (CLI subprocess), "openai" (OpenAI-compatible API), or "ai_sdk" (Rust ai-sdk-openai-compatible)
    ...
    """
    name: str
    type: str = "claude"  # "claude", "openai", "gemini", or "ai_sdk"
